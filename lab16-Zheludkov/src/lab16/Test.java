...
//        test.viewList();
//  }
        MenuItem drink01 = new Drink("Drink1", "Drink1_description", 100);
        MenuItem drink02 = new Drink("Drink2", "Drink2_description", 114);
        MenuItem drink03 = new Drink("Drink3", "Drink3_description", 99);
        MenuItem drink04 = new Drink("Drink4", "Drink4_description", 10234);
        ...
        MenuItem[] itemsArray = order.SortedItemsByCost();
        System.out.println("\nSorted by cost:");
